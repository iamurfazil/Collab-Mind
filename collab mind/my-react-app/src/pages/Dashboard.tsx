...
import MyIdeas from '../features/problems/components/MyIdeas';
import BrowseIdeas from '../features/problems/components/BrowseIdeas';
import Requests from '../features/projects/components/Requests';
import Chat from '../features/chat/components/Chat';
import Submissions from '../features/projects/components/Submissions';
import Certificates from '../features/user/components/Certificates';
import Settings from '../features/user/components/Settings';
import ProfileModal from '../features/user/components/ProfileModal';
import CurrentProjects from '../features/projects/components/CurrentProjects';
...
  className="mt-2 p-2 rounded-xl bg-white shadow-sm border border-gray-200"
>
  <button
    onClick={handleLogout}
    className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left text-red-500 hover:bg-red-50 cursor-hover"
  >
...
                <button
                  onClick={handleLogout}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-red-500 hover:bg-red-50 cursor-hover"
                >
