...
        />
      </bufferGeometry>
      <pointsMaterial size={0.1} color="#FB923C" transparent opacity={0.6} sizeAttenuation />
    </points>
  );
}
...
      <gridHelper args={[40, 40, '#F97316', '#F97316']} rotation={[0, 0, 0]}>
        <meshBasicMaterial attach="material" color="#F97316" wireframe transparent opacity={0.15} />
      </gridHelper>
    </group>
  );
}
...
        <pointLight position={[10, 5, 5]} intensity={0.5} color="#FB923C" />
        
        <AnimatedSphere position={[-4, 1, -2]} color="#F97316" scale={0.9} speed={2.5} />
        <AnimatedSphere position={[4, -1, -1]} color="#FB923C" scale={0.7} speed={2} />
        <AnimatedSphere position={[0, 2, -3]} color="#F97316" scale={0.5} speed={3} />
        <AnimatedSphere position={[-2, -2, -2]} color="#FB923C" scale={0.4} speed={2} />
        
        <AnimatedTorus position={[3, 2, -4]} color="#F97316" scale={0.6} />
        <AnimatedTorus position={[-3, -1, -3]} color="#FB923C" scale={0.4} />
        
        <AnimatedIcosahedron position={[0, -2, -4]} color="#F97316" scale={0.5} />
        
        <Particles />
        <RingParticles />
        <GridLines />
