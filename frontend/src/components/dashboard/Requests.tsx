...
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-400 flex items-center justify-center text-white text-sm font-bold">
...
                        email: ''
                      })}
                      className="text-orange-500 hover:text-orange-400 text-sm cursor-hover"
                    >
                      View Profile
                    </button>
                  </div>
...
                      <span className="text-sm font-medium text-orange-500">Applicant's Answer</span>
                    </div>
                    <p className="text-gray-600">{request.answer}</p>
                  </div>
                </div>
